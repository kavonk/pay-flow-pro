...
/**
 * DeploymentHealthStatusResponse
 * Response model for deployment health status.
 */
export interface DeploymentHealthStatusResponse {
  /** Status */
  status: string;
  /** Message */
  message: string;
...
export type GetSettlementSummaryData = SettlementSummary;
...
export type GetFinancialStatsData = FinancialStats;
...
export type GetDeploymentLogsData = DeploymentLogsResponse;

export type GetDeploymentLogsError = HTTPValidationError;

export type CreateDeploymentLogData = DeploymentLogEntry;

export type CreateDeploymentLogError = HTTPValidationError;

export type DeploymentLogsHealthCheckData = any;

export type DeploymentHealthCheckData = HealthCheckResponse;

export type DeploymentStatusCheckData = DeploymentHealthStatusResponse;

export type DeploymentCronHealthCheckData = any;
