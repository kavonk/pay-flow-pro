                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            <div 
                              ...
                              onClick={() => {
                                if (!hasCustomBrandingAccess()) return;
                                const input = document.createElement('input');
                                input.type = 'color';
                                input.value = formData.primary_color || '#3B82F6';
                                input.onchange = (e) => updateFormData('primary_color', (e.target as HTMLInputElement).value);
                                input.click();
                              }}
                            />
                            <Input
                          ...
                          <div className="flex items-center gap-3">
                            <div 
                              ...
                              onClick={() => {
                                ...
                                const input = document.createElement('input');
                                input.type = 'color';
                                input.value = formData.accent_color || '#10B981';
                                input.onchange = (e) => updateFormData('accent_color', (e.target as HTMLInputElement).value);
                                input.click();
                              }}
                            />
                            <Input
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <Input
                                ...
                                placeholder="#3B82F6"
                                disabled={!hasCustomBrandingAccess()}
                                className="border-2 focus:border-blue-500 font-mono text-xs"
                              />
                            </div>
                          </div>
